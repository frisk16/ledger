...
INSERT IGNORE INTO users (id, role_id, name, email, password, address, phone_number, enabled) VALUES (3, 2, 'Test User', 'test@gmail.com', '$2a$08$KSdI/mVRMi8nAFeuN5egCurmh4uEUzKMtrP67tGqaOTvD9w5uiqNC', '神奈川県', '01-2345-6789', 1);
